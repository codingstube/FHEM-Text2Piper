...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive TZ=Etc/UTC apt-get -y install tzdata \
    build-essential apt-utils vim bzip2 tar gzip git curl wget python3 python3-pip cmake ca-certificates alsa-utils\
...
RUN echo -e "https://huggingface.co/rhasspy/piper-voices/resolve/main/de/de_DE/kerstin/low/de_DE-kerstin-low.onnx\n \
https://huggingface.co/rhasspy/piper-voices/resolve/main/de/de_DE/kerstin/low/de_DE-kerstin-low.onnx.json\n \
https://huggingface.co/rhasspy/piper-voices/resolve/main/de/de_DE/kerstin/low/MODEL_CARD" > kerstin_low_model_file_urls.txt

# Download all URLs listed in the file
RUN wget -i kerstin_low_model_file_urls.txt -P $CODE_PATH/piper/voices/kerstint/low
